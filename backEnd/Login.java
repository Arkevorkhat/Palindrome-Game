...
public class Login { // TO DO: Create login sequence and implement session creation.
	...
	public static void register()
	{
		...
		String chosen = (String) JOptionPane.showInputDialog(
				(Component) null, "What kind of user would you like to register as?", "User Type",
				JOptionPane.DEFAULT_OPTION, null, uType, uType[0]
		);
		...
		case "Student":
			...
			int GL = (int) JOptionPane.showInputDialog(
					null, "What Grade are you in?", "Grade Level", JOptionPane.DEFAULT_OPTION, null, levels, levels[3]
			);
		...
		case "Teacher":
			...
			try
			{
				new Teacher(un, pw, null, 0l).addToSet();
